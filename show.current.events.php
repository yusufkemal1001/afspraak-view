...
ON events.frequency_id=frequency.frequency_id AND end_time between start_time and end_time where DATE(`start_time`) = CURDATE() and current_timestamp < end_time and start_time < current_timestamp ORDER BY start_time asc;
";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {?>
        ...
        <div class="w-5/6 rounded-md max-h-40 bg-green-300 h-25 m-auto p-2 mb-5 flex justify-center">
            <div class="flex">
